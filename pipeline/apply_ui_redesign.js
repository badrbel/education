...
if (emojiRegex.test(replacement3AS) || emojiRegex.test(replacement4AM)) {
  console.error('Emoji detected! Aborting.');
  process.exit(1);
}

fs.writeFileSync(htmlPath, newHtml, 'utf-8');
console.log('Successfully updated index.html with redesigned subject cards!');
